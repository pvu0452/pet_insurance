...
`;
 ...
 useEffect(() => {
  ...
  async function refreshPricing(updatedPets: Pet[]) {
  try {
    ...
    const basePayload = {
      ...
      customer: {
        suburb:
          petData?.addressDetails?.suburb || "",

        state:
          petData?.addressDetails?.state || "",

        postcode:
          petData?.addressDetails?.postcode || "",
